...
// TODO: add code here
   // add creator 
    ...
    //console.log(ApplePie.creator);
   
   //add elements of ingredients in a array 
   var ingredientss = document.getElementById("ingredient-list").getElementsByTagName("li");
   
   console.log(ingredientss);
   
   var ingre;
   
   for (ingre = 0; ingre < ingredientss.length; ingre++) {
	   ApplePie.ingredients.push(ingredientss[ingre].innerHTML);
   }
   
   console.log(ApplePie.ingredients);
...
// TODO:
  // eerst de element opvragen en vervolgens via onclick een bericht sturen naar de consol 
  var imgclick = document.getElementsByClassName("pie")[1];
  
  imgclick.onclick = function(){
	 // console.log('hello, world!');
	  imgclick.addEventListener("click",console.log('hello, world!'),false);
	  }
...
function createTransform(domain, range){
	...
	var beta = domain[1] - domain[1] ;
	var alpha = range[0] -range[1] ;
